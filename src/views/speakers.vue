            ...
            <v-layout wrap align-center justify-center row fill-height class="pa-3">
                <v-flex xs12 md8 lg8>
                    ...
                    <p class="mt-0 google-font subheading">
                        ...
                        Get ready to be inspired by these amazing professional speakers who are going to share their knowledge and
                        experience on TensorFlow, Kotlin, Machine Learning and much more.
