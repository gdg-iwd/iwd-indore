            ...
            <v-layout wrap align-center justify-center row fill-height class="pa-3">
                ...
                <v-flex xs12 md8 lg8 class="">
                    ...
                    <p class="mt-0 google-font subheading">
                        We know that <b>when women support each other, incredible things happen,</b> so our major objective is to encourage,elevate and support each and every woman in technology and boost the amount of female participation.
