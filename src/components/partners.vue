<template>
    <v-container fluid class="mt-3">
        <v-layout wrap align-center justify-center row fill-height>
            ...
            <v-flex xs12 md12 class="mt-2">
                <p class="google-font mt-2" style="font-size:110%">Event Partner</p>
                        ...
                        <v-card class="elevation-0 pa-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0">
                                <v-layout row wrap class="ma-1">
                                    ...
                                    >
                                        <v-card flat tile class="d-flex">
                                            <a href="https://www.engineerbabu.com/" target="_blank">
                                                <v-img
                                                        :src="require('../assets/img/partners/Ebabu-Icon.jpg')"
                                                        :lazy-src="require('../assets/img/partners/Ebabu-Icon.jpg')"
                                                        aspect-ratio="2.34"
                                                        contain
                                                        class="white"
                                                >
